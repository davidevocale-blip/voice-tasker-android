...
import com.voicetasker.app.data.ai.SupabaseNoteAiProcessor
...
abstract class AppModule {
    @Binds @Singleton abstract fun bindNoteAiProcessor(impl: SupabaseNoteAiProcessor): NoteAiProcessor
